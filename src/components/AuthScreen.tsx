...
export default function AuthScreen() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-6 text-center">
      ...
      <p className="text-zinc-400 font-medium mb-10 max-w-[260px]">
        Track your finances, sync with your partner in real-time.
      </p>
      <button
        onClick={handleLogin}
        className="h-14 px-8 bg-white text-black font-bold rounded-2xl flex items-center gap-3 active:scale-95 transition-transform"
      >
